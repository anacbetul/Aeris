...
model = load_model("efficientnetb0_giyim_modeli_datagen_dense.h5")

with open("label_encoder_efficientnet_datagen_dense.pkl", "rb") as f:
    le = pickle.load(f)

#  3. Test görselini tahmin et
# test_image_path = "C:\\Users\\21360859036\\Desktop\\ootd\\deepfashion\\images\\2685.jpg"
test_image_path= "C:\\Users\\21360859036\\Desktop\\3.jpg"
