...
base_model.trainable = True  # tümü değil, sadece son 20 katman
...
# Modeli kaydet
model.save("mobilenet_giyim_modeli_learning_rate.h5")

# LabelEncoder'ı kaydet
import pickle

with open("label_encoder_mobilnet_learning_rate.pkl", "wb") as f:
    pickle.dump(le, f)
