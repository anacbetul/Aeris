...
for layer in base_model.layers[:-25]:  # son 25 katman eğitilebilir
...
# Model kaydet
model.save("googlenet_inceptionv3_modeli_transfer.h5")

# LabelEncoder kaydet
with open("label_encoder_googlenet_inceptionv3_transfer.pkl", "wb") as f:
    pickle.dump(le, f)
