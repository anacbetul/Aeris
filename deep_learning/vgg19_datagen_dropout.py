...
for layer in base_model.layers[:-4]:  # son birkaç katmanı eğitime aç
...
# Modeli kaydet 
model.save("vgg19_giyim_modeli_lessdatagen_lessdropout.h5")

# LabelEncoder'ı kaydet
with open("label_encoder_vgg19_lessdatagen_lessdropout.pkl", "wb") as f:
    pickle.dump(le, f)
