...
# 9️ Transfer learning - VGG16
base_model = VGG16(weights='imagenet', include_top=False, input_shape=(128, 128, 3))
base_model.trainable = True
for layer in base_model.layers[:-20]:  # son birkaç katmanı eğitime aç
...
# Modeli kaydet
model.save("vgg16_giyim_modeli_datagen.h5")

# LabelEncoder'ı kaydet
with open("label_encoder_vgg16_datagen.pkl", "wb") as f:
    pickle.dump(le, f)
